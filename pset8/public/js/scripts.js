...
$(function() {
    ...
    var options = {
        center: {lat: 25.7320365, lng: -80.2433555}, // Coconut Grove
...
function addMarker(place)
{
    ...
    // EXPLODE (aka "extra feature")
    google.maps.event.addListener(marker, 'mouseover', function() { 
        marker.setIcon(cursor_image);
    });
    google.maps.event.addListener(marker, 'mouseout', function() { 
        marker.setIcon(image);
    });
            
    // get content from articles.php
    google.maps.event.addListener(marker, 'click', function() {
        $.getJSON("articles.php", {geo: place.postal_code})
            .done(function(data, textStatus, jqXHR) {
                ...
                // create unordered list of news articles
                else
                {
                   var template = _.template("<li><a href='<%- link %>' target='_blank'>'<%- title %>'</a></li>");
                   var title = _.template("<h2 class=iw-title><span class=fuego>Fuego!</span> <%- place_name %>, <%- admin_name1 %></h2>"); // place.place_name place.admin_name1
                   
                   var content = title({place_name: place.place_name, admin_name1: place.admin_name1}) + "<ul>";
